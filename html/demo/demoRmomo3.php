...
<html lang="en">
  <head>
    ...
    <title>REngine9 DemoRmomo3</title>
  ...
  <body>
    ...
    <div class="container container-padded">
      <div class="jumbotron">
        <h2>REngine9 Demo3</h2><br>
        
        
          <button type="button" onclick="Test(Hi yohooo);" class="btn btn-danger">Trigger an EvalError</button>
        <script>
            function Test(text) {
                eval('(' + text + ')');
            }
...
'Ausr' : null, 'Ausrid' : 'YI2VKiZ33YOxE','Aprj' : 'TzY0y7rO0aOuY', 'ADD' : null};
